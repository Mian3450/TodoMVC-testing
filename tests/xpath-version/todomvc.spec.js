...
test('todo is mark as completed', async () => {
  ...
  await browser.all('//*[contains(@id, "todo-list")]/li').should(have.exactTexts('a', 'b', 'c'))

  // WHEN
  await browser.element('//*[contains(@id, "todo-list")]/li[2]//*[@class="toggle"]').click()

  // THEN
  await browser.all('//*[contains(@id, "todo-list")]/li[contains(@class, "completed")]').should(have.exactTexts('b'))
  await browser.all('//*[contains(@id, "todo-list")]/li[not(contains(@class, "completed"))]').should(have.exactTexts('a', 'c'))
